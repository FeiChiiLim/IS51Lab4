"""
This program allows a user to guess the correct answer to the question
...
to see if the answer matches the true answer. If so, print "Correct!", then terminates the loop with a
break statement.

if the user could not guess the correct answer within the max_tries, then print
"You have used up your allotment of guesses.", then print "The correct answer is 'Sacremento'".
"""
...
ask
  ...
  if not correct
    ...
    print the correct answer "The correct answer is 'Sacremento'"
main
"""
